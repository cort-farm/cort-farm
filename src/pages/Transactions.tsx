...
const typeLabels: Record<string, string> = {
  sale: "بيعة نقدية", debt_added: "دين مضاف", debt_paid: "سداد دين",
  debtor_added: "مدين جديد", debtor_collected: "تحصيل", withdrawal: "سحب شخصي",
};
      ...
      >
        ...
        <div className="flex gap-2 flex-wrap">
          <Select value={filterType} onValueChange={setFilterType}>
            <SelectTrigger className="w-40 rounded-xl h-10 bg-muted/40 border-border/60">
              <SelectValue />
            </SelectTrigger>
            <SelectContent>
