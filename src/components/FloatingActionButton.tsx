...
const actions = [
  ...
  { label: "إضافة مدين", icon: Users, color: "bg-sky-500", shadow: "shadow-sky-500/40", action: "debtor" },
...
export default function FloatingActionButton({ onAddSale, onAddDebt, onAddDebtor, onAddWithdrawal, onPayDebt, onCollectDebtor }: FABProps) {
    ...
    <>
      ...
      <div className="fixed bottom-7 left-6 z-40 flex flex-col-reverse items-end gap-2.5" dir="rtl">
        ...
        <motion.button
          ...
          className={cn(
            "w-15 h-15 rounded-2xl bg-primary text-white shadow-xl shadow-primary/35",
