...
import {
  ...
  Moon, Sun, TrendingUp, Menu, X, ChevronLeft,
} from "lucide-react";
import {
        ...
        <div className="px-3 py-4 border-t border-sidebar-border/60 space-y-2">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <button className="flex items-center gap-3 w-full px-3 py-2.5 rounded-xl hover:bg-sidebar-accent transition-all duration-200 group">
